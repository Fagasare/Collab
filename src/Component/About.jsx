            ...
            <section className="section">
                ...
                <div className="row align-items-center">
                    ...
                    <div className="about-desc ml-lg-4">
                        ...
                        Aenean eros et nisl sagittis as vestibulum at Nullam nulla eros
                        ultricies site amet nonummy id imperdiet feugiat pede as Sed
                        lectuse Donec mollis hendrerit Phasellus at nec sem in at
                        pellentesque facilisis at Praesent congue erat at massa Sed sit
                        cursus turpis vitae tortor that a Donec posuere as vulputate arcu
                        Phasellus accumsan velit.
                        </p>
                        <p className="text-muted">
                        Maecenas tempus tellus eget as that condimentum rhoncus sem quam
                        semper libero amete adipiscing sem neque sed ipsum Nam quam nunce
                        blandit at luctus pulvinar hendrerit id lorem Maecenas nec et ante
                        tincidunt tempus.
                        </p>
                        <p className="text-muted">
            ...
            <section className="section">
                ...
                <div className="row align-items-center">
                    ...
                    <p className="text-muted f-14">
                        ...
                        luctus at id lorem maecenas nec odio et ante tincidunt tempus Donec
                        vitae venenatis faucibus quis ante.
                    </p>
