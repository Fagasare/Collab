                    ...
                    <div className="container">
                      ...
                      <div className="row justify-content-center">
                        <div className="col-12 text-center mt-4 pt-2">
                          <a href="/allcategories" className="btn btn-primary-outline">
                            Browse All Categories <i className="mdi mdi-chevron-right" />
                          </a>
                        </div>
                      </div>
                    </div>
                                    ...
                                    <div className="p-3 bg-light">
                                      <div className="row">
                                        <div className="col-md-4">
                                          <div>
                                            <p className="text-muted mb-0 mo-mb-2">
                                              <span className="text-dark">Experience :</span> 1
                                              - 2 years
                                            </p>
                                          </div>
                                        </div>
                                    ...
                                    <div className="p-4">
                                      <div className="row align-items-center">
                                        ...
                                        <div className="col-md-2">
                                          <div>
                                            <p className="text-muted mb-0 mo-mb-2">
                                              <span className="text-primary">$</span>900-1100/m
                                            </p>
                                          </div>
                                        </div>
                                        <div className="col-md-2">
                                    ...
                                    <div className="p-3 bg-light">
                                      <div className="row">
                                        <div className="col-md-10">
                                          <div>
                                            <p className="text-muted mb-0 mo-mb-2">
                                              <span className="text-dark">Experience :</span> 2
                                              - 3 years
                                            </p>
                                          </div>
                                        </div>
                                    ...
                                    <div className="p-4">
                                      <div className="row align-items-center">
                                        ...
                                        <div className="col-md-2">
                                          <div>
                                            <p className="text-muted mb-0 mo-mb-2">
                                              <span className="text-primary">$</span>800-1000/m
                                            </p>
                                          </div>
                                        </div>
                                        <div className="col-md-2">
                                    ...
                                    <div className="p-3 bg-light">
                                      <div className="row">
                                        <div className="col-md-4">
                                          <div>
                                            <p className="text-muted mb-0 mo-mb-2">
                                              <span className="text-dark">Experience :</span> 0
                                              - 1 years
                                            </p>
                                          </div>
                                        </div>
                          ...
                          <div className="how-it-work-box bg-light p-4 text-center rounded shadow">
                            ...
                            <div>
                              ...
                              <p className="text-muted">
                                ...
                                In enim justo rhoncus ut a, justo.
                              </p>
                        ...
                        <div className="col-md-4 mt-4 pt-2">
                          <div className="how-it-work-box bg-light p-4 text-center rounded shadow">
                            ...
                            <div>
                              ...
                              <p className="text-muted">
                                Aliquam lorem ante dapibus in, viverra feugiatquis a tellus.
                                Phasellus viverra nulla ut Quisque rutrum.
                              </p>
