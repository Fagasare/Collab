                ...
                <div className="row">
                    ...
                    <div className="sidebar mt-sm-30 p-4 rounded shadow">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="post-recent-content float-left">
                                <a href="jvascript:void(0)">Look On The Glorious Balance</a>{" "}
                                <span className="text-muted mt-2">15th June, 2019</span>
                            </div>
                            </div>
                            <div className="clearfix post-recent">
                    ...
                    <div className="shadow rounded p-4">
                        ...
                        <ul className="list-inline mb-1">
                            ...
                            <li className="list-inline-item mr-4">
                            <p className="text-muted mb-0">
                                <i className="mdi mdi-message-reply-text mr-1" />4 Comments
                            </p>
                            </li>
                            <li className="list-inline-item">
                            <p className="text-muted mb-0">
                        ...
                        <p className="text-muted mb-3 f-13">
                            ...
                            herself on the way But nothing the copy said could convince her
                            and s didn’t take long until a few insidious Copy Writers
                            ambushed made her drunk with Longe and Parole and dragged a into
                            their agency where they abused her for their projects again and
                            again. And if hasn’t been rewritten.
                        </p>
                        <p className="text-muted f-13">
                            The copy warned the Little Blind Text that where it came from
                            would have rewritten thousand times and everything that was left
                            from its origin would be the word and the Little Blind Text
                            should turn around and return its own, safe country But nothing
                            the copy said could convince.
                        </p>
                        <blockquote className="blockquote p-4 position-relative">
                            ...
                            has control about the blind texts it is an almost
                            unorthographic life One day however a small line of blind text
                            by the name as of Lorem Ipsum decided to leave.
                            </p>
                            <h6 className="mb-0">
                            <a href="#" className="text-dark">
                                By : Maude J. McDowell
                    ...
                    <div className="rounded border mt-4 p-4">
                        ...
                        <div className="media-body ml-3">
                            ...
                            <div className="media-body ml-3">
                                ...
                                <p className="text-muted mb-0">03, Oct, 2018 At 06.05pm</p>
                                <p className="text-muted f-14 mb-2">
                                Nam libero tempore, cum soluta nobis est at eligendi optio
                        ...
                        <div className="media-body ml-3">
                            ...
                            had a last view on the skyline her hometown the headline.
                            </p>
                            <p className="mb-0">
                            <a href className="text-muted">
                                <i className="mdi mdi-reply-all mr-2" />
