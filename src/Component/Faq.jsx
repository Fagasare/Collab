                ...
                <div className="row">
                        ...
                        <div className="accordion" id="accordionExample">
                            ...
                            >
                                ...
                                <p className="text-muted mb-0 faq-ans">
                                    ...
                                    repudiandae sint et molestiae non recusandae that Itaque
                                    earum rerum sapiente delectus, ut aut reiciendis
                                    voluptatibus maiores alias consequatur aut perferendis
                                    was doloribus asperiores repellat sed ut perspiciatis
                                    unde omnis iste natus error at accusantium doloremque
                    ...
                    <div className="faq-content mt-5">
                        ...
                        <div className="accordion" id="accordionExample2">
                            ...
                            >
                                <div className="card-header bg-light p-3" id="headingsevan">
                                <h6 className="title mb-0 faq-question">
                            ...
                            >
                                <div className="card-header bg-light p-3" id="headingeight">
                                <h6 className="title mb-0 faq-question">
                            ...
                            >
                                <div className="card-header bg-light p-3" id="headingnine">
                                <h6 className="title mb-0 faq-question">
                            ...
                            >
                                <div className="card-header bg-light p-3" id="headingten">
                                <h6 className="title mb-0 faq-question">
